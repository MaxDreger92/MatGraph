...
class UserService {
    ...
    static async sendConfirmationMail(usermail: any) {
        try {
            ...
            const htmlPath = require("os").homedir() + '/MatGraph/userBackendNodeJS/src/static/confirmation-mail.html'
    ...
    static async sendVerificationMail(username: any, usermail: any) {
        try {
            ...
            const htmlPath = require("os").homedir() + '/MatGraph/userBackendNodeJS/src/static/verification-mail.html'
            let html = fs.readFileSync(htmlPath, 'utf8')
    ...
    static async sendVerificationConfirmation(usermail: any) {
        try {
            const htmlPath = require("os").homedir() + '/MatGraph/userBackendNodeJS/src/static/verified-mail.html'
            let html = fs.readFileSync(htmlPath, 'utf8')
    ...
    static getConfirmedPage(confirmed: boolean) {
        ...
        let html = ''
        if (confirmed) {
            pagePath = require("os").homedir() + '/MatGraph/userBackendNodeJS/src/static/email-confirmed.html'
        } else {
            pagePath = require("os").homedir() + '/MatGraph/userBackendNodeJS/src/static/confirmation-error.html'
        }
    ...
    static getVerifiedPage(verified: boolean) {
        ...
        let html = ''
        if (verified) {
            pagePath = require("os").homedir() + '/MatGraph/userBackendNodeJS/src/static/user-verified.html'
        } else {
            pagePath = require("os").homedir() + '/MatGraph/userBackendNodeJS/src/static/verification-error.html'
        }
        html = fs.readFileSync(pagePath, 'utf8')
        return html
    }
